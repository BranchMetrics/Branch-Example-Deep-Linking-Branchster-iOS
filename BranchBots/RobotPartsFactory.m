...
+ (NSArray *)descriptionArray {
    if (!descriptionArray)
        descriptionArray = @[
                             ...
                             @"%@ is very busy and very hungry.  He prefers to work alone and is impatient with hierarchies and politics.  Although he’s not particularly social, he has a razor sharp wit (and claws), and is actually very fun to be around. But hide your food. Those donuts you were saving for tomorrow? Gone. Those leftovers from the picnic? Done. An unstoppable force, %@ gets hungry often, so watch out.",
                             @"Independent and ferocious, %@ experiences life at 100 mph. Not interested in maintaining order, %@ is a fierce individual who is highly effective, successful, and incredibly powerful. Always bossing others around, he’s the big toe of the group -- hence the nickname.",
